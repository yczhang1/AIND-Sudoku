...
class TestNakedTwins(unittest.TestCase):
    def test_naked_twins(self):
    	...
    	my_solution = solution.naked_twins(before_naked_twins)
    	print("\nMY SOLUTION")
    	solution.display(my_solution)
    	
    	self.assertEqual(my_solution, after_naked_twins)
...
class TestDiagonalSudoku(unittest.TestCase):
    def test_solve(self):
    	...
    	print("\nMY SOLUTION")
    	solution.display(solution.solve(diagonal_grid))
